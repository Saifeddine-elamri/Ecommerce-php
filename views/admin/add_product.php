...
<?php endif; ?>
<form method="POST" action="/admin/product/add" class="bg-white p-6 rounded shadow max-w-md mx-auto">
    <div class="mb-4">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="image" class="w-full p-2 border rounded" value="default.jpg">
    </div>
